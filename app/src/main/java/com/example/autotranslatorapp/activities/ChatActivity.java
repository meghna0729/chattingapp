package com.example.autotranslatorapp.activities;
...
import com.example.autotranslatorapp.adapters.ChatAdapter;
import com.example.autotranslatorapp.databinding.ActivityChatBinding;
import com.example.autotranslatorapp.models.ChatMessage;
import com.example.autotranslatorapp.models.User;
import com.example.autotranslatorapp.network.ApiClient;
import com.example.autotranslatorapp.network.ApiService;
import com.example.autotranslatorapp.utilities.Constants;
import com.example.autotranslatorapp.utilities.PreferenceManager;
        ...
        if (value != null) {
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if(documentChange.getType()==DocumentChange.Type.ADDED){
                    ...
                    chatMessages.dateTime = getReadableDateTime(documentChange.getDocument().getDate(Constants.KEY_TIMESTAMP));
